...
class KBAccountReport(models.AbstractModel):
    _name = 'report.kb_partner_balance_check.account_report_balance_check'
    _description = "Report Account"

    @api.model
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('kb_account_reports_partner_balance.account_report_template.xml')
