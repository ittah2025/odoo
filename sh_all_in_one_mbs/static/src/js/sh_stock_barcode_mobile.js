$(document).ready(function () {
    ...
    function decodeOnce(codeReader, selectedDeviceId) {
        codeReader
            ...
            .then((result) => {
                console.log(result);
                var el = document.getElementById("sh_stock_barcode_mobile");
    ...
    console.log("stock ZXing code reader initialized");
    codeReader
        ...
        .then(function (result) {
            ...
            $(document).on('change', '#js_id_sh_stock_barcode_mobile_cam_select', function (ev) {
                ...
                if ($('div[name="sh_stock_bm_is_cont_scan"] span:contains("True")').length) {
