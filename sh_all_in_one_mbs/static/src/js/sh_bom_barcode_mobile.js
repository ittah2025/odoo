$(document).ready(function () {
    ...
    function decodeOnce(codeReader, selectedDeviceId) {
        codeReader
            ...
            .then((result) => {
                console.log(result);
                var el = document.getElementById("sh_bom_barcode_mobile");
    ...
    console.log("bom ZXing code reader initialized");
    codeReader
        ...
        .then(function (result) {
            ...
            $(document).on("click", "#js_id_sh_bom_barcode_mobile_start_btn", function (event) {
                ...
                if ($('div[name="sh_bom_bm_is_cont_scan"] span:contains("True")').length) {
