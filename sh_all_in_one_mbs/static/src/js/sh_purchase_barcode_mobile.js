$(document).ready(function () {
    ...
    function decodeOnce(codeReader, selectedDeviceId) {
        codeReader
            ...
            .then((result) => {
                ...
                // -------------------------------------
                var el = document.getElementById("sh_purchase_barcode_mobile");
    ...
    console.log("purchase ZXing code reader initialized");
    codeReader
        ...
        .then(function (result) {
            ...
            $(document).on("click", "#js_id_sh_purchase_barcode_mobile_start_btn", function (event) {
                ...
                if ($('div[name="sh_purchase_bm_is_cont_scan"] span:contains("True")').length) {
