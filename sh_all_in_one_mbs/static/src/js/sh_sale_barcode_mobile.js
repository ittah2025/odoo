$(document).ready(function () {
    ...
    function decodeOnce(codeReader, selectedDeviceId) {
        codeReader
            ...
            .then((result) => {
                ...
                // -------------------------------------
                var el = document.getElementById("sh_sale_barcode_mobile");
    ...
    console.log("sale ZXing code reader initialized");
    codeReader
        ...
        .then(function (result) {
            ...
            $(document).on("click", "#js_id_sh_sale_barcode_mobile_start_btn", function (event) {
                ...
                if ($('div[name="sh_sale_bm_is_cont_scan"] span:contains("True")').length) {
