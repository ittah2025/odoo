...
class SaleOrder(models.Model):
    ...
    def action_cancel(self):
        ...
        for order in self:
            ...
            if points_history:
                order.partner_id.loyalty_points -= points_history.points
    ...
    def action_redeem_points(self):
        ...
        default_points = min(self.partner_id.loyalty_points + self.points_spent, float_round(self.amount_total / loyalty.per_point_value, precision_digits=pd) + self.points_spent)
