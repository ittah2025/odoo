...
class LoyaltyProgram(models.Model):
    ...
    per_point_value = fields.Float(string="Per Point Value", digits='Sale Loyalty', default=1.000)
    ...
    _sql_constraints = [
        ('per_point_value_gt_zero', 'CHECK (per_point_value>0)', 'Per point value cannot be <= 0!')
    ]
