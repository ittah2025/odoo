...
class PurchaseRequestAllocation(models.Model):
    ...
    company_id = fields.Many2one(
        ...
        readonly=True,
        related="purchase_request_line_id.company_id",
        store=True,
        index=True,
    )
    ...
    product_id = fields.Many2one(
        ...
        related="purchase_request_line_id.kb_product_id",
        readonly=True,
    )
    ...
    def _notify_allocation(self, allocated_qty):
        ...
        for allocation in self:
            request = allocation.purchase_request_line_id.kb_product_line_ids
