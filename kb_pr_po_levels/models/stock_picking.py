...
class KbStockpPicking(models.Model):
    ...
    def _action_cancel_create_mail_activity(self):
        ...
        for move in self:
            if move.created_purchase_request_line_id:
                ...
                if pr_line.kb_product_id.responsible_id:
                    activity_user = pr_line.kb_product_id.responsible_id
                elif pr_line.kb_product_line_ids.assigned_to:
                    activity_user = pr_line.kb_product_line_ids.assigned_to
                ...
                self.env["mail.activity"].sudo().create(
                    {
                        ...
                        "res_id": pr_line.kb_product_line_ids.id,
    ...
    def _compute_purchase_request_ids(self):
        for rec in self:
            rec.purchase_request_ids = (
                rec.purchase_request_allocation_ids.purchase_request_line_id.kb_product_line_ids
            )
