...
class ResConfigSettings(models.TransientModel):
    ...
    module_oursms_gateway = fields.Boolean(
        string='Install OurSms SMS Gateway', help='It will Install OurSms sms gateway automatically.', default=False)
    is_oursms_in_addon = fields.Boolean(default=_check_oursms)
