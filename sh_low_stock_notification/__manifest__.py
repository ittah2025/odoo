...
# Copyright (C) Softhealer Technologies.
{
    ...
    'version': '16.0.1',
    'category': "Warehouse",
    'summary': "Product Low Stock Alert,product low stock email, low stock product alert,product minimum stock alerts,warehouse low stock alerts, display low stock quantity, product stock alert,Minimum Stock Reminder,Print product Low Stock Report odoo",
