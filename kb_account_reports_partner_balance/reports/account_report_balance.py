...
class KBBalanceAccountReport(models.AbstractModel):
    _name = 'report.kb_account_reports_partner_balance.account_report_2'
    _description = "Report Account"

    @api.model
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('kb_account_reports_partner_balance.account_report_balance_template.xml')
