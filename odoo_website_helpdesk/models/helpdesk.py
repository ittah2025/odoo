...
class HelpDeskTicket(models.Model):
    ...
    customer_id = fields.Many2one('res.users',
                                  ...
                                  help='Customer Name', default=lambda self: self.env.user)
    ...
    description = fields.Text('Description', required=True,
                              help='Description')
    email = fields.Char('Email', help='Email',related="customer_id.login")
    phone = fields.Char('Phone', help='Contact Number',related="customer_id.partner_id.phone")
    ...
    def mail_snd(self):
        ...
        if self.stage_id.reopen_stage:
            data.reopen_stage = True
    ...
    def assign_me(self):
        if not self.assigned_user:
            self.assigned_user = self.env.user
class StageTicket(models.Model):
    ...
    starting_stage = fields.Boolean('Start Stage', default=False,
                                    help='Starting Stage')
    reopen_stage = fields.Boolean('Reopen Stage', default=False,
                                    help='Reopen Stage')
