...
export class InvoicingViews extends Component {
    constructor(...args) {
        super(...args);
        this.products;
    }
...
InvoicingViews.components = { WithSearch };

Object.assign(InvoicingViews, {
    props: {
    ...
    template: 'basic.invoicingView',
});

registerMessagingComponent(InvoicingViews);
