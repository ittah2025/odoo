...
export class SalesViews extends Component {
    constructor(...args) {
        super(...args);
        this.products;
    }
...
SalesViews.components = { WithSearch };

Object.assign(SalesViews, {
    props: {
    ...
    template: 'basic.SalesViews',
});

registerMessagingComponent(SalesViews);
