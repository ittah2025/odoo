...
export class PurchaseViews extends Component {
    constructor(...args) {
        super(...args);
        this.products;
    }
...
PurchaseViews.components = { WithSearch };

Object.assign(PurchaseViews, {
    props: {
    ...
    template: 'basic.projectsView',
});

registerMessagingComponent(PurchaseViews);
