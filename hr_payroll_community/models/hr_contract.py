...
class HrContract(models.Model):
    ...
    # new Allowance's
    fixed_allowance = fields.Monetary(string="Fixed Allowance", help="Travel allowance")
    unfixed_allowance = fields.Monetary(string="Unfixed Allowance", help="Unfixed Allowance")
    working_other_companies_allowance = fields.Monetary(string="Working In Other Companies Allowance", help="Working In Other Companies Allowance")
    # End of new Allowance's
